...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "sumsel_ticketing_at_localhost";
		$data["connName"] = "sumsel_ticketing at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;sumsel_ticketing;;1"; //currently unused

		$this->_connectionsIdByName["sumsel_ticketing at localhost"] = "sumsel_ticketing_at_localhost";
...
;
		...
		$connectionsData["sumsel_ticketing_at_localhost"] = $data;
