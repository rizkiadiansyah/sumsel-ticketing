...
class ConnectionManager_Base
{
	...
	{
		return $this->byId( "sumsel_ticketing_at_localhost" );
	}
	...
	{
		$connectionsIds = array();
		$connectionsIds["tbl_users"] = "sumsel_ticketing_at_localhost";
		$connectionsIds["pengajuan_ticket_hdr"] = "sumsel_ticketing_at_localhost";
		$connectionsIds["pengajuan_ticket_dtl"] = "sumsel_ticketing_at_localhost";
		$connectionsIds["admin_rights"] = "sumsel_ticketing_at_localhost";
		$connectionsIds["admin_members"] = "sumsel_ticketing_at_localhost";
		$connectionsIds["admin_users"] = "sumsel_ticketing_at_localhost";
		$connectionsIds["tbl_code_list"] = "sumsel_ticketing_at_localhost";
		$connectionsIds["list_airlane"] = "sumsel_ticketing_at_localhost";
		$connectionsIds["list_airport"] = "sumsel_ticketing_at_localhost";
		$connectionsIds["list_ccemail"] = "sumsel_ticketing_at_localhost";
		$connectionsIds["list_data_penumpang"] = "sumsel_ticketing_at_localhost";
		$connectionsIds["ticket_attachments"] = "sumsel_ticketing_at_localhost";
		$connectionsIds["list_sbu"] = "sumsel_ticketing_at_localhost";
