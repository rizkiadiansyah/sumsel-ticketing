...
{
	$value = "";
				if($table=="ticket_attachments" && $field=="attachment")
	{
		;
		return $value;
	}
...
function GetDefaultValue($field, $ptype, $table="")
{
	...
	if(!$table)
		$table=$strTableName;
				if($table=="list_airlane" && $field=="CatID")
	{
		return $values["CatID"] = "AIRLINE";;
	}
				if($table=="list_airport" && $field=="CatID")
	{
		return $values["CatID"] = "AIRPORT";;
	}
				if($table=="list_ccemail" && $field=="CatID")
	{
		return $values["CatID"] = "email_cc";;
	}
				if($table=="list_sbu" && $field=="CatID")
	{
		return $values["CatID"] = "SBU";;
	}
	return "";
}
