...
if(mlang_getcurrentlang()=="English")
{
	...
	$fieldLabelsadmin_users["English"]["nik"] = "Nik";
	$fieldToolTipsadmin_users["English"]["nik"] = "";
	$placeHoldersadmin_users["English"]["nik"] = "";
	$fieldLabelsadmin_users["English"]["nama"] = "Nama";
	$fieldToolTipsadmin_users["English"]["nama"] = "";
	$placeHoldersadmin_users["English"]["nama"] = "";
	$fieldLabelsadmin_users["English"]["posisi"] = "Posisi";
	$fieldToolTipsadmin_users["English"]["posisi"] = "";
	$placeHoldersadmin_users["English"]["posisi"] = "";
	$fieldLabelsadmin_users["English"]["sbu"] = "Sbu";
	$fieldToolTipsadmin_users["English"]["sbu"] = "";
	$placeHoldersadmin_users["English"]["sbu"] = "";
	$fieldLabelsadmin_users["English"]["no_hp"] = "No Hp";
	$fieldToolTipsadmin_users["English"]["no_hp"] = "";
	$placeHoldersadmin_users["English"]["no_hp"] = "";
	...
	$placeHoldersadmin_users["English"]["role"] = "";
	...
	$fieldLabelsadmin_users["English"]["remember_token"] = "Remember Token";
	$fieldToolTipsadmin_users["English"]["remember_token"] = "";
	$placeHoldersadmin_users["English"]["remember_token"] = "";
	$fieldLabelsadmin_users["English"]["created_at"] = "Created At";
	$fieldToolTipsadmin_users["English"]["created_at"] = "";
	$placeHoldersadmin_users["English"]["created_at"] = "";
	$fieldLabelsadmin_users["English"]["updated_at"] = "Updated At";
	$fieldToolTipsadmin_users["English"]["updated_at"] = "";
	$placeHoldersadmin_users["English"]["updated_at"] = "";
...
$tdataadmin_users[".connId"] = "sumsel_ticketing_at_localhost";
...
$tdataadmin_users[".googleLikeFields"][] = "nik";
$tdataadmin_users[".googleLikeFields"][] = "no_hp";
$tdataadmin_users[".googleLikeFields"][] = "password";
$tdataadmin_users[".googleLikeFields"][] = "posisi";
$tdataadmin_users[".googleLikeFields"][] = "remember_token";
$tdataadmin_users[".googleLikeFields"][] = "role";
$tdataadmin_users[".googleLikeFields"][] = "sbu";
$tdataadmin_users[".googleLikeFields"][] = "updated_at";
...
$tdataadmin_users[".sqlHead"] = "SELECT created_at,  	email,  	id,  	is_active,  	nama,  	nik,  	no_hp,  	password,  	posisi,  	remember_token,  	`role`,  	sbu,  	updated_at";
...
//end of Filters settings
	...
	$tdataadmin_users["created_at"] = $fdata;
		$tdataadmin_users[".searchableFields"][] = "created_at";
//	email
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 2;
...
//	Custom field settings
	...
	$fdata["GoodName"] = "nik";
	$fdata["ownerTable"] = "tbl_users";
	$fdata["Label"] = GetFieldLabel("admin_users","nik");
	$fdata["FieldType"] = 200;
...
//end of Filters settings
	...
	$tdataadmin_users["nik"] = $fdata;
		$tdataadmin_users[".searchableFields"][] = "nik";
//	no_hp
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 7;
	...
	$fdata["ownerTable"] = "tbl_users";
	$fdata["Label"] = GetFieldLabel("admin_users","no_hp");
	$fdata["FieldType"] = 200;
...
//end of Filters settings
	...
	$tdataadmin_users["no_hp"] = $fdata;
		$tdataadmin_users[".searchableFields"][] = "no_hp";
//	password
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 8;
...
//	Custom field settings
	...
	$fdata["ownerTable"] = "tbl_users";
	$fdata["Label"] = GetFieldLabel("admin_users","posisi");
	$fdata["FieldType"] = 200;
...
//end of Filters settings
	...
	$tdataadmin_users["posisi"] = $fdata;
		$tdataadmin_users[".searchableFields"][] = "posisi";
//	remember_token
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 10;
	...
	$fdata["ownerTable"] = "tbl_users";
	$fdata["Label"] = GetFieldLabel("admin_users","remember_token");
	$fdata["FieldType"] = 200;
...
//end of Filters settings
	...
	$tdataadmin_users["remember_token"] = $fdata;
		$tdataadmin_users[".searchableFields"][] = "remember_token";
//	role
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 11;
	...
	$fdata["GoodName"] = "role";
	$fdata["ownerTable"] = "tbl_users";
	$fdata["Label"] = GetFieldLabel("admin_users","role");
	$fdata["FieldType"] = 129;
...
//end of Filters settings
	...
	$tdataadmin_users["role"] = $fdata;
		$tdataadmin_users[".searchableFields"][] = "role";
//	sbu
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 12;
	...
	$fdata["GoodName"] = "sbu";
	$fdata["ownerTable"] = "tbl_users";
	$fdata["Label"] = GetFieldLabel("admin_users","sbu");
	$fdata["FieldType"] = 200;
...
//end of Filters settings
	...
	$tdataadmin_users["sbu"] = $fdata;
		$tdataadmin_users[".searchableFields"][] = "sbu";
//	updated_at
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 13;
	...
	$fdata["ownerTable"] = "tbl_users";
	$fdata["Label"] = GetFieldLabel("admin_users","updated_at");
	$fdata["FieldType"] = 135;
...
//end of Filters settings
	...
	$tdataadmin_users["updated_at"] = $fdata;
		$tdataadmin_users[".searchableFields"][] = "updated_at";
...
$proto0["m_strFieldList"] = "created_at,  	email,  	id,  	is_active,  	nama,  	nik,  	no_hp,  	password,  	posisi,  	remember_token,  	`role`,  	sbu,  	updated_at";
