...
class ProjectSettings
{
	...
	*/
	...
	function getConnId()
	{
		...
		if( $connId == "" ) {
			return "sumsel_ticketing_at_localhost";
		}
		return $connId;
	}
...
function fillProjectEntites()
{
	...
	$projectEntities[ "pengajuan_ticket_hdr" ] = array( "url" => "pengajuan_ticket_hdr", "type" => 1 );
	$projectEntitiesReverse[ "pengajuan_ticket_hdr" ] = "pengajuan_ticket_hdr";
	$projectEntities[ "pengajuan_ticket_dtl" ] = array( "url" => "pengajuan_ticket_dtl", "type" => 1 );
	$projectEntitiesReverse[ "pengajuan_ticket_dtl" ] = "pengajuan_ticket_dtl";
	...
	$projectEntities[ "tbl_code_list" ] = array( "url" => "tbl_code_list", "type" => 0 );
	$projectEntitiesReverse[ "tbl_code_list" ] = "tbl_code_list";
	$projectEntities[ "list_airlane" ] = array( "url" => "list_airlane", "type" => 1 );
	$projectEntitiesReverse[ "list_airlane" ] = "list_airlane";
	$projectEntities[ "list_airport" ] = array( "url" => "list_airport", "type" => 1 );
	$projectEntitiesReverse[ "list_airport" ] = "list_airport";
	$projectEntities[ "list_ccemail" ] = array( "url" => "list_ccemail", "type" => 1 );
	$projectEntitiesReverse[ "list_ccemail" ] = "list_ccemail";
	$projectEntities[ "list_data_penumpang" ] = array( "url" => "list_data_penumpang", "type" => 1 );
	$projectEntitiesReverse[ "list_data_penumpang" ] = "list_data_penumpang";
	$projectEntities[ "ticket_attachments" ] = array( "url" => "ticket_attachments", "type" => 1 );
	$projectEntitiesReverse[ "ticket_attachments" ] = "ticket_attachments";
	$projectEntities[ "list_sbu" ] = array( "url" => "list_sbu", "type" => 1 );
	$projectEntitiesReverse[ "list_sbu" ] = "list_sbu";
}
