...
class DB
{
	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "sumsel_ticketing_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "sumsel-ticketinguggroups", "varname" => "sumsel_ticketing_at_localhost__sumsel_ticketinguggroups", "altvarname" => "sumsel_ticketinguggroups", "connId" => "sumsel_ticketing_at_localhost", "schema" => "", "connName" => "sumsel_ticketing at localhost");
			$dalTables[$conn->connId][] = array("name" => "sumsel-ticketingugmembers", "varname" => "sumsel_ticketing_at_localhost__sumsel_ticketingugmembers", "altvarname" => "sumsel_ticketingugmembers", "connId" => "sumsel_ticketing_at_localhost", "schema" => "", "connName" => "sumsel_ticketing at localhost");
			$dalTables[$conn->connId][] = array("name" => "sumsel-ticketingugrights", "varname" => "sumsel_ticketing_at_localhost__sumsel_ticketingugrights", "altvarname" => "sumsel_ticketingugrights", "connId" => "sumsel_ticketing_at_localhost", "schema" => "", "connName" => "sumsel_ticketing at localhost");
			$dalTables[$conn->connId][] = array("name" => "tbl_code_list", "varname" => "sumsel_ticketing_at_localhost__tbl_code_list", "altvarname" => "tbl_code_list", "connId" => "sumsel_ticketing_at_localhost", "schema" => "", "connName" => "sumsel_ticketing at localhost");
			$dalTables[$conn->connId][] = array("name" => "tbl_data_penumpang", "varname" => "sumsel_ticketing_at_localhost__tbl_data_penumpang", "altvarname" => "tbl_data_penumpang", "connId" => "sumsel_ticketing_at_localhost", "schema" => "", "connName" => "sumsel_ticketing at localhost");
			$dalTables[$conn->connId][] = array("name" => "tbl_pengajuan_ticket_dtl", "varname" => "sumsel_ticketing_at_localhost__tbl_pengajuan_ticket_dtl", "altvarname" => "tbl_pengajuan_ticket_dtl", "connId" => "sumsel_ticketing_at_localhost", "schema" => "", "connName" => "sumsel_ticketing at localhost");
			$dalTables[$conn->connId][] = array("name" => "tbl_pengajuan_ticket_hdr", "varname" => "sumsel_ticketing_at_localhost__tbl_pengajuan_ticket_hdr", "altvarname" => "tbl_pengajuan_ticket_hdr", "connId" => "sumsel_ticketing_at_localhost", "schema" => "", "connName" => "sumsel_ticketing at localhost");
			$dalTables[$conn->connId][] = array("name" => "tbl_ticket_attachments", "varname" => "sumsel_ticketing_at_localhost__tbl_ticket_attachments", "altvarname" => "tbl_ticket_attachments", "connId" => "sumsel_ticketing_at_localhost", "schema" => "", "connName" => "sumsel_ticketing at localhost");
			$dalTables[$conn->connId][] = array("name" => "tbl_users", "varname" => "sumsel_ticketing_at_localhost__tbl_users", "altvarname" => "tbl_users", "connId" => "sumsel_ticketing_at_localhost", "schema" => "", "connName" => "sumsel_ticketing at localhost");
		}
	}
