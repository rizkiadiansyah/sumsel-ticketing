...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("tbl_users" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_pengajuan_ticket_hdr" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_pengajuan_ticket_dtl" == $this->chrt_array['tables'][0])
			return true;
		if("sumsel-ticketingugrights" == $this->chrt_array['tables'][0])
			return true;
		if("sumsel-ticketingugmembers" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_users" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_code_list" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_code_list" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_code_list" == $this->chrt_array['tables'][0])
		...
		if("tbl_code_list" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_data_penumpang" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_ticket_attachments" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_code_list" == $this->chrt_array['tables'][0])
			return true;
		return false;
