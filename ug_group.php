...
$nonAdminTablesArr[] = "tbl_users";
$nonAdminTablesArr[] = "pengajuan_ticket_hdr";
$nonAdminTablesArr[] = "pengajuan_ticket_dtl";
$nonAdminTablesArr[] = "tbl_code_list";
$nonAdminTablesArr[] = "list_airlane";
$nonAdminTablesArr[] = "list_airport";
$nonAdminTablesArr[] = "list_ccemail";
$nonAdminTablesArr[] = "list_data_penumpang";
$nonAdminTablesArr[] = "ticket_attachments";
$nonAdminTablesArr[] = "list_sbu";
...
$wGroupTableName = $ug_connection->addTableWrappers( "sumsel-ticketinguggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "sumsel-ticketingugrights" ) 
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "sumsel-ticketingugrights" );
