...
require_once("include/pengajuan_ticket_hdr_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "pengajuan_ticket_hdr" );
