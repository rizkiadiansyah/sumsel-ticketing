...
require_once("include/pengajuan_ticket_dtl_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "pengajuan_ticket_dtl" );
