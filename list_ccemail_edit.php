...
require_once("include/list_ccemail_variables.php");
...
$keys["Code"] = postvalue("editid2");
$keys["Description"] = postvalue("editid3");
$keys["Description2"] = postvalue("editid4");
$keys["AssRec"] = postvalue("editid5");
